        ...
        >
            ...
            <div className="flex-grow w-full flex items-center justify-center mb-2 z-10 relative">
                <img
                    ...
                    alt="Individual Plantation"
                    className="h-full w-full object-contain group-hover:scale-110 transition-transform duration-500 drop-shadow-sm"
                />
            </div>
