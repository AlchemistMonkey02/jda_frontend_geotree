...
const Mapping = () => {
    return (
        <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] p-3 sm:p-5 shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition-shadow duration-300 min-h-[160px] sm:min-h-[240px] cursor-pointer group relative overflow-hidden">
